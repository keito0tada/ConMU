...
def parse_args():
    ...
    parser.add_argument(
        "--data",
        type=str,
        default="Tab_Data/Adult/adult.csv",
        help="location of the data corpus",
    )
    parser.add_argument(
        "--dataset",
        type=str,
        default="cifar10",
        help="[Adult, Breast_Cancer, Diabetes]",
    )
    parser.add_argument(
        "--data_dir",
        type=str,
    ...
    parser.add_argument(
        "--workers", type=int, default=3, help="number of workers in dataloader"
    )
    ...
    parser.add_argument(
        "--rate", default=0.1, type=float, help="pruning rate"
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="epoch to train the unleanring proxy model",
    )
    parser.add_argument("--class_wise", type=str, default=None, help="class to forget")

    parser.add_argument(
        "--retain_filter_up",
        type=float,
        default=0.3,
        help="retain_filter_up * std is upper bound for retain data filter",
    )
    parser.add_argument(
        "--retain_filter_lower",
        type=float,
        default=0.17,
        help="retain_filter_lower * std is lower bound for retain data filter",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="forget_filter_up * std is the upper bound for forget data filter",
    )
    parser.add_argument(
        "--forget_filter_lower",
        type=float,
        default=0.85,
        help="forget_filter_lower * std is the lower bound for forget data filter",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="forget percentage for forget loader",
    )
    parser.add_argument(
        "--further_train_epoch",
        type=int,
        default=10,
        help="rewinding epoch during further train",
    )
    parser.add_argument(
        "--further_train_lr",
        type=float,
        default=1e-4,
        help="learning rate during further train",
    )
    parser.add_argument(
    ...
    parser.add_argument("--alpha", default=3, type=float, help="unlearn noise")
    parser.add_argument(
        "--num_noise", default=2, type=int, help="num of noise added to image"
    )
    parser.add_argument(
        "--kl_weight",
        type=float,
    ...
    parser.add_argument(
        "--temperature", type=float, default=2.0, help="temperature for KL loss"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="number of epochs for retrian using only the retained data",
    )
    parser.add_argument(
        "--retrain_lr", default=1e-4, type=float, help="retrain learning rate"
    )
